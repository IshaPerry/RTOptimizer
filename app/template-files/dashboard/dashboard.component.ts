...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.powerCapacityLineChartLabels = ["JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"];
    ...
    this.resourceStrainBarChartData = [
      ...
      this.resourceStrainBarChartColors = [
       {
         borderColor: "#18ce0f",
         pointBorderColor: "#FFF",
    ...
    this.resourceStrainBarChartLabels = ["12pm,", "3pm", "6pm", "9pm", "12am", "3am", "6am", "9am"];
    this.resourceStrainBarChartOptions = this.gradientChartOptionsConfigurationWithNumbersAndGrid;

    this.resourceStrainBarChartType = 'line';
    ...
    this.wifiStrainChartLabels = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
